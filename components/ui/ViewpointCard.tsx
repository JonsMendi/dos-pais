...
import type { Viewpoint } from "@/data/viewpoints";
import { useTranslation } from "@/lib/i18n/useTranslation";

export default function ViewpointCard({ name, description, mapsUrl, tip }: Viewpoint) {
